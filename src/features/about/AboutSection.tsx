          ...
          <div className="divide-y divide-neutral-800">
            <div className="pb-6">
              ...
              <h4 className="text-lg font-semibold dark:text-neutral-100 flex items-center gap-2">
                <FaGraduationCap className="text-brand-light shrink-0" size={20} />
                {t('about.university')}
              </h4>
            ...
            <div className="pt-6">
              ...
              <h4 className="text-lg font-semibold dark:text-neutral-100 flex items-center gap-2">
                <FaGlobe className="text-brand-light shrink-0" size={20} />
                {t('about.erasmus')}
              </h4>
          ...
          <div className="divide-y divide-neutral-800">
            <div className="flex items-start gap-4 py-4 first:pt-0">
              <div className="w-10 h-10 rounded-xl bg-brand/10 flex items-center justify-center shrink-0">
                <FaCode className="text-brand-light" size={18} />
              </div>
